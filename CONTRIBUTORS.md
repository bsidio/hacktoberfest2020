...
Name: [Bryan Hafidz](https://github.com/MumetNgoding) <br/>
Place: Indonesia <br/>
About: Linux Geek, Android Developer and Kernel Builder <br />
Programming Languages: C, C++, Python, Kotlin, Java<br/>
Email: bryanhafidz@hack.id<br/>
